...
void motor_init(void){
    DIO_SetPinDirection(PORT_B,0,OUTPUT);
    DIO_SetPinDirection(PORT_B,1,OUTPUT);
    DIO_SetPinDirection(PORT_B,2,OUTPUT);
    DIO_SetPinDirection(PORT_B,3,OUTPUT);

    DIO_SetPinValue(PORT_B,0,LOW);
    DIO_SetPinValue(PORT_B,1,LOW);
    DIO_SetPinValue(PORT_B,2,LOW);
    DIO_SetPinValue(PORT_B,3,LOW);

}
void motor_on(void){
    DIO_SetPinValue(PORT_B,0,LOW);
    DIO_SetPinValue(PORT_B,1,HIGH);
    DIO_SetPinValue(PORT_B,2,LOW);
    DIO_SetPinValue(PORT_B,3,LOW);
}
void motor_off(void){
    DIO_SetPinValue(PORT_B,0,HIGH);
    DIO_SetPinValue(PORT_B,1,LOW);
    DIO_SetPinValue(PORT_B,2,LOW);
    DIO_SetPinValue(PORT_B,3,LOW);
}
