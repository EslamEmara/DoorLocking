...
void LCD_init(void)
{
 ...
 DIO_SetPinDirection( PORT_D,3, OUTPUT);
 DIO_SetPinDirection( PORT_D,1, OUTPUT);
 DIO_SetPinDirection( PORT_D,2, OUTPUT);

 DIO_SetPortValue(PORT_D, 0x00);
 DIO_SetPortValue(PORT_D, 0x00);


    DIO_SetPinDirection(PORT_D, 4, OUTPUT);
    DIO_SetPinDirection(PORT_D, 5, OUTPUT);
    DIO_SetPinDirection(PORT_D, 6, OUTPUT);
    DIO_SetPinDirection(PORT_D, 7, OUTPUT);
...
void LCD_sendCommand(uint8_t command)
{
 ...
 DIO_SetPinValue(PORT_D,1, LOW);


 DIO_SetPinValue(PORT_D,2, LOW);
 _delay((unsigned long)((1)*(4000000/4000.0)));



 DIO_SetPinValue(PORT_D,3, HIGH);
 ...
 _delay((unsigned long)((1)*(4000000/4000.0)));
    ...
    DIO_SetUpperHalfPortValue(PORT_D, (command & 0xF0));


 _delay((unsigned long)((1)*(4000000/4000.0)));


 DIO_SetPinValue( PORT_D,3, LOW);
 ...
 DIO_SetUpperHalfPortValue(PORT_D, ((command & 0x0F) << 4));
...
void LCD_displayCharacter(uint8_t data)
{
 ...
 DIO_SetUpperHalfPortValue(PORT_D, (data & 0xF0));
 ...
 DIO_SetUpperHalfPortValue(PORT_D, ((data & 0x0F) << 4));
 _delay((unsigned long)((1)*(4000000/4000.0)));
 DIO_SetPinValue( PORT_D,3, LOW);
    _delay((unsigned long)((1)*(4000000/4000.0)));
